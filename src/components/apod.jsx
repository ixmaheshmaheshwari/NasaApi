...
const Apod = () => {
  ...
  const [apiUrl] = useState(import.meta.env.VITE_APOD_URL);
  ...
  return (
    <>
      ...
      >
        <div>
          <h1 className="flex items-center justify-center my-3 text-3xl font-bold">
              ...
              {(src, loading) => (
                <div className="flex items-center justify-center w-full h-full">
                  ...
                  <img
                    ...
                    alt={data.id}
                    className={`mt-4 h-128 w-128  mr-auto ml-auto ${
                      loading ? "w-16 h-16" : ""
          ...
          <div className="explain mt-3">
            ...
            <p className="mt-2 text-justify text-black  p-2">
